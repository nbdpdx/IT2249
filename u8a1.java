...
public class U8A1_2DConsoleRegisterForCourse {
            ...
            switch (ValidateChoice(choice, validChoices, totalCredit, courses)) {
                ...
                case 0:
                    ...
                    if (validChoices[0][0].equals("")) {
                            ...
                            validChoices[0][1] = courses[0][choice-1]; // ADDED [1] SO ARRAY WOULD RUN CORRECTLY
    ...
    public static int getChoice(String[][] courses, Scanner input) { // ADDED SECOND SQUARE BRACKETS FOR ARRAY
    ...
    public static int ValidateChoice(int choice, String[][] validChoices, int totalCredit, String[][] courses) {
        ...
        if (choice < 1 || choice > 7)
            return -1;
                ...
                || choiceAsString.equals(validChoices[1][0]) // ADDED [1] SO ARRAY WOULD RUN CORRECTLY
    ...
    public static void WriteCurrentRegistration(String[][] validChoices, int totalCredit) {
        ...
        if (validChoices[0][0].equals(""))
            ...
            System.out.println("Current course registration: { " + validChoices[0][1] + " }" ); // REMOVED [i] ADDED [1] SO CODE WOULD RUN CORRECTLY
        else if (validChoices[2][0].equals(""))
